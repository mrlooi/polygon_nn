...
class UnetGenerator(nn.Module):
    def __init__(self, input_nc, output_nc, num_downs, ngf=64,
        ...
        # start by creating the innermost of the U-net i.e. the middle (and smallest) down + up layers, then next layer, until outermost of U-net
...
def define_D(model_type, num_classes,
                init_type='normal', init_gain=0.02, gpu_ids=[]):
    netD = None

    if model_type == 'resnet18':
        netD = models.resnet18(num_classes=num_classes)
    elif model_type == 'resnet34':
        netD = models.resnet34(num_classes=num_classes)
    else:
